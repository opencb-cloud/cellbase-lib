...
//	DBConnector ros1;
//	GeneDBManager gf1;
	GeneDBManager geneDBManager;
	DBConnector infraredDBConnector;
	@Before
...
//		gf1 = new GeneDBManager(ros1);
		infraredDBConnector = new DBConnector();
		geneDBManager = new GeneDBManager(infraredDBConnector);
...
//		ros1.getDbConnection().disconnect();
	...
	@Test
	public void getAll() throws SQLException, IllegalAccessException, ClassNotFoundException, InstantiationException {
